...
struct attrib_state * attrib_newstate(const unsigned char inherit_mask[128]);
...
int attrib_release(struct attrib_state *, attrib_t);
...
attrib_t attrib_inherit(struct attrib_state *, attrib_t child, attrib_t parent, int with_mask);
